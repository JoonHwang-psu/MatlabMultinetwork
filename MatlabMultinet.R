...
# 2. Descriptives statistics of household and network characteristics

## descriptive statistics of HH demography
...
## descriptives statistics of household network characteristics
...
### land ownership
landfin<-by(finsupp[, c("indegree", "outdegree", "eigencentrality", "betweenesscentrality", "Hub", "Authority")], finsupp$new_land2, colMeans)
(landfin <- do.call(rbind, landfin))
wilcox.test(indegree~new_land2, data=finsupp)
wilcox.test(outdegree~new_land2, data=finsupp)
wilcox.test(eigencentrality~new_land2, data=finsupp)
wilcox.test(betweenesscentrality~new_land2, data=finsupp)
wilcox.test(Hub~new_land2, data=finsupp)
wilcox.test(Authority~new_land2, data=finsupp)

### salaried income
salfin<-by(finsupp[, c("indegree", "outdegree", "eigencentrality", "betweenesscentrality", "Hub", "Authority")], finsupp$new_salaried, colMeans)
(salfin <- do.call(rbind, salfin))
wilcox.test(indegree~new_salaried, data=finsupp)
wilcox.test(outdegree~new_salaried, data=finsupp)
wilcox.test(eigencentrality~new_salaried, data=finsupp)
wilcox.test(betweenesscentrality~new_salaried, data=finsupp)
wilcox.test(Hub~new_salaried, data=finsupp)
wilcox.test(Authority~new_salaried, data=finsupp)

### institutional social status
statfin<-by(finsupp[, c("indegree", "outdegree", "eigencentrality", "betweenesscentrality", "Hub", "Authority")], finsupp$new_status, colMeans)
(statfin <- do.call(rbind, statfin))
wilcox.test(indegree~new_status, data=finsupp)
wilcox.test(outdegree~new_status, data=finsupp)
wilcox.test(eigencentrality~new_status, data=finsupp)
wilcox.test(betweenesscentrality~new_status, data=finsupp)
wilcox.test(Hub~new_status, data=finsupp)
wilcox.test(Authority~new_status, data=finsupp)

## network characteristics in material support layer

### land ownership
landmat<-by(matsupp[, c("indegree", "outdegree", "eigencentrality", "betweenesscentrality", "Hub", "Authority")], matsupp$new_land2, colMeans)
(landmat <- do.call(rbind, landmat))
wilcox.test(indegree~new_land2, data=matsupp)
wilcox.test(outdegree~new_land2, data=matsupp)
wilcox.test(eigencentrality~new_land2, data=matsupp)
wilcox.test(betweenesscentrality~new_land2, data=matsupp)
wilcox.test(Hub~new_land2, data=matsupp)
wilcox.test(Authority~new_land2, data=matsupp)

### salaried income
salmat<-by(matsupp[, c("indegree", "outdegree", "eigencentrality", "betweenesscentrality", "Hub", "Authority")], matsupp$new_salaried, colMeans)
(salmat <- do.call(rbind, salmat))
wilcox.test(indegree~new_salaried, data=matsupp)
wilcox.test(outdegree~new_salaried, data=matsupp)
wilcox.test(eigencentrality~new_salaried, data=matsupp)
wilcox.test(betweenesscentrality~new_salaried, data=matsupp)
wilcox.test(Hub~new_salaried, data=matsupp)
wilcox.test(Authority~new_salaried, data=matsupp)

### institutional social status
statmat<-by(matsupp[, c("indegree", "outdegree", "eigencentrality", "betweenesscentrality", "Hub", "Authority")], matsupp$new_status, colMeans)
(statmat <- do.call(rbind, statmat))
wilcox.test(indegree~new_status, data=matsupp)
wilcox.test(outdegree~new_status, data=matsupp)
wilcox.test(eigencentrality~new_status, data=matsupp)
wilcox.test(betweenesscentrality~new_status, data=matsupp)
wilcox.test(Hub~new_status, data=matsupp)
wilcox.test(Authority~new_status, data=matsupp)

## network characteristics in labor support layer

### land ownership
landlab<-by(labsupp[, c("indegree", "outdegree", "eigencentrality", "betweenesscentrality", "Hub", "Authority")], labsupp$new_land2, colMeans)
(landlab <- do.call(rbind, landlab))
wilcox.test(indegree~new_land2, data=labsupp)
wilcox.test(outdegree~new_land2, data=labsupp)
wilcox.test(eigencentrality~new_land2, data=labsupp)
wilcox.test(betweenesscentrality~new_land2, data=labsupp)
wilcox.test(Hub~new_land2, data=labsupp)
wilcox.test(Authority~new_land2, data=labsupp)

### salaried income
sallab<-by(labsupp[, c("indegree", "outdegree", "eigencentrality", "betweenesscentrality", "Hub", "Authority")], labsupp$new_salaried, colMeans)
(sallab <- do.call(rbind, sallab))
wilcox.test(indegree~new_salaried, data=labsupp)
wilcox.test(outdegree~new_salaried, data=labsupp)
wilcox.test(eigencentrality~new_salaried, data=labsupp)
wilcox.test(betweenesscentrality~new_salaried, data=labsupp)
wilcox.test(Hub~new_salaried, data=labsupp)
wilcox.test(Authority~new_salaried, data=labsupp)

### institutional social status
statlab<-by(labsupp[, c("indegree", "outdegree", "eigencentrality", "betweenesscentrality", "Hub", "Authority")], labsupp$new_status, colMeans)
(statlab <- do.call(rbind, statlab))
wilcox.test(indegree~new_status, data=labsupp)
wilcox.test(outdegree~new_status, data=labsupp)
wilcox.test(eigencentrality~new_status, data=labsupp)
wilcox.test(betweenesscentrality~new_status, data=labsupp)
wilcox.test(Hub~new_status, data=labsupp)
wilcox.test(Authority~new_status, data=labsupp)
